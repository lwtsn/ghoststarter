...
contract Whitelist is Ownable {
    ...
    modifier onlyWhitelisted() {
        if (hasWhitelisting) {
            require(isWhitelisted(msg.sender), "Not on the white list");
        }
        _;
    }
   ...
   */
    ...
    */
    ...
    function fund(uint256 _amount) public isSalePreStarted {
        ...
        /* Confirm transfer tokens is no more than needed */

        // todo is this even needed
//        require(availableTokens().add(_amount) <= tokensForSale, "Transfer tokens have to be equal or less than proposed");
